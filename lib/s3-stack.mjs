...
class S3Stack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        const parameterReaderR2R = new SSMParameterReader(this, `parameterReaderR2R`, {
        ...
        const parameterReaderChatbot = new SSMParameterReader(this, `parameterReaderChatbot`, {
